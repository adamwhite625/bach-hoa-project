...
const categories = [
  {
    ...
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/vegetables_fruits_nxftak.jpg",
  },
  {
    name: "Thịt, trứng, hải sản",
    description: "Các loại thịt, trứng và hải sản tươi sống",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/meat_fish_egg_rqgpzl.jpg",
  },
  {
    name: "Gia vị, thực phẩm khô",
    description: "Gia vị và các loại thực phẩm khô",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/spices_dry_food_kxhqtl.jpg",
  },
  {
    name: "Sữa, sản phẩm từ sữa",
    description: "Sữa và các sản phẩm được chế biến từ sữa",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/milk_dairy_products_pqxwvn.jpg",
  },
];
...
const products = [
  {
    ...
    sku: "WTM001",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/products/watermelon_fqcr3l.jpg",
  ...
  },
  {
    ...
    sku: "VEG001",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/products/cai_ngong_sxkpql.jpg",
    category: "Rau củ, trái cây",
  },
  {
    ...
    sku: "DRG001",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/products/thanh_long_ruot_do_yqgxpn.jpg",
    category: "Rau củ, trái cây",
  },
  {
    name: "Cà rốt Đà Lạt",
    ...
    sku: "CRT001",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/products/ca_rot_dalat_hqvpxk.jpg",
    category: "Rau củ, trái cây",
  },
  {
    ...
    sku: "SPC001",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/products/nuoc_mam_3_mien_nwhpxk.jpg",
  ...
  },
  {
    ...
    sku: "FSH001",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/products/ca_bac_ma_kxhqtl.jpg",
  ...
  },
  {
    ...
    sku: "PRK001",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/products/ba_roi_heo_cj_pqxwvn.jpg",
    category: "Thịt, trứng, hải sản",
  },
  {
    name: "File ức gà 3F",
    ...
    sku: "CHK001",
    image:
      "https://res.cloudinary.com/daeeumk1i/image/upload/v1761288815/products/uc_ga_3f_nxftak.jpg",
    category: "Thịt, trứng, hải sản",
  },
];
...
async function seedData() {
  try {
    ...
    const order1ItemsPrice =
      order1Products[0].price * 2 + order1Products[1].price * 1;
    ...
    const order2ItemsPrice =
      order2Products[0].price * 1 + order2Products[1].price * 2;
    ...
    const ordersWithIds = [
      {
        ...
        orderItems: [
          {
            product: order1Products[0]._id,
            name: order1Products[0].name,
            image: order1Products[0].image,
            price: order1Products[0].price,
            quantity: 2,
          },
          {
            product: order1Products[1]._id,
            name: order1Products[1].name,
            image: order1Products[1].image,
            price: order1Products[1].price,
            quantity: 1,
          },
        ],
        shippingAddress: sampleOrders[0].shippingAddress,
        paymentMethod: sampleOrders[0].paymentMethod,
      ...
      },
      {
        ...
        orderItems: [
          {
            product: order2Products[0]._id,
            name: order2Products[0].name,
            image: order2Products[0].image,
            price: order2Products[0].price,
            quantity: 1,
          },
          {
            product: order2Products[1]._id,
            name: order2Products[1].name,
            image: order2Products[1].image,
            price: order2Products[1].price,
            quantity: 2,
          },
        ],
        shippingAddress: sampleOrders[1].shippingAddress,
        paymentMethod: sampleOrders[1].paymentMethod,
        itemsPrice: order2ItemsPrice,
        taxPrice: order2TaxPrice,
        shippingPrice: order2ShippingPrice,
        totalPrice: order2TotalPrice,
        status: sampleOrders[1].status,
        isPaid: false,
        isDelivered: false,
      },
    ];
